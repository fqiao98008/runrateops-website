# Runrate Operations — Consulting Website
...
3. Add environment variables in the Vercel dashboard:
   - `NEXT_PUBLIC_SITE_URL` = `https://runrateops.com`
...
|---|---|
| `NEXT_PUBLIC_SITE_URL` | Your production URL, e.g. `https://runrateops.com` |
...
- [x] Dynamic OG image generated by `app/opengraph-image.tsx` (can override with static `public/og-image.png` later if desired)
